    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4">Monthly Sales ({{ now()->year }})</h3>
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center space-x-3">
                                        <div class="w-8 h-8 bg-indigo-100 rounded-full flex items-center justify-center">
                                            <span class="text-xs font-medium text-indigo-600">{{ $month['month'] }}</span>
                                        </div>
                                    ...
                                    <div class="text-right">
                                        <p class="text-sm font-medium text-gray-900">{{ $month['orders'] }} orders</p>
                                        <p class="text-xs text-gray-500">${{ number_format($month['revenue'], 2) }}</p>
                                    </div>
                                </div>
                            @endforeach
                        </div>
